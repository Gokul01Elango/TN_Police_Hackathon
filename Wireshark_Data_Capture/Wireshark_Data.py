...
with open(CSV_FILENAME, 'w', newline='') as csv_file:
    ...
    writer.writerow(['Source IP', 'Destination IP', 'Source Port', 'Destination Port', 'Source MAC', 'Destination MAC'])
    ...
    for packet in capture.sniff_continuously():
        ...
        writer.writerow([ip_src, ip_dst, port_src, port_dst, mac_src, mac_dst])
